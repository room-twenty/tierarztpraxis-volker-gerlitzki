    ...
    <section>
      ...
      <div className="cards_impressum">
        <p className="paraImpr">
          Es gelten unsere Allgemeinen Geschäftsbedingungen. Sofern Teile oder
          ...
          Teile in ihrem Inhalt und ihrer Gültigkeit davon unberührt.
        </p>
        <br />
        <p className="paraImpr">
          Für Schäden durch Medikationen und Behandlungen, die mittels
          Informationen dieser Website oder Verweisen von dieser Site
          vorgenommen wurden, ist jede Haftung ausgeschlossen. Wir empfehlen in
          jedem Krankheitsfall eine ärztliche oder anderweitig medizinische
          Hilfe zu Rate zu ziehen.
        </p>
        <br />
        <p className="paraImpr">
          Die Tierarztpraxis Gerlitzki übernimmt keine Haftung für Schäden, die
          durch die Nutzung der Internet-Sites entstehen. Dies betrifft jegliche
          Probleme, die während oder nach der Nutzung der Website auf dem
          Rechner oder im Netzwerk des Nutzers auftreten, seien es Ausfälle von
          Hard- oder Software, Datenverluste, Virenbefall oder andere
          Unregelmäßigkeiten. Es können weder für direkte Schäden noch für
          Folgeschäden (Zeitverlust, indirekte Schäden, entgangener Gewinn)
          Schadenersatzansprüche geltend gemacht werden.
        </p>
        <br />
        <p className="paraImpr">
          Für den Inhalt externer Links sind ausschließlich dessen Urheber und
          Autoren, nicht jedoch die Tierarztpraxis Gerlitzki verantwortlich. Zum
          Zeitpunkt der Verknüpfung waren diese frei von illegalen Inhalten.
        </p>
        <br />
        <div className="einrückImpr">
          <h3 className="cards_title">Verantwortlich gem. §6 MDStV:</h3>
          ...
          <p className="paraImpr">
            E-Mail:{' '}
            <a className="site-links" href="mailto:praxis@vet-gerlitzki.de">
        ...
        <div className="einrückImpr">
          <h3 className="cards_title">Zuständige Aufsichtsbehörde:</h3>
          <p className="paraImpr">
        ...
        <div className="einrückImpr">
          <h3 className="cards_title">Gesetzliche Berufsbezeichnung:</h3>
        ...
        <div className="einrückImpr">
          ...
          <p className="paraImpr">
            Die berufsrechtlichen Regelungen sind über die Internetseiten der
            Tierärztekammer Hamburg zugänglich. Der direkte Link lautet:{' '}
            <a
              className="site-links"
        ...
        <div className="einrückImpr">
          ...
          <p className="paraImpr">Versicherungsnehmer: Volker R. Gerlitzki</p>
          <p className="paraImpr">Räumlicher Geltungsbereich: Deutschland</p>
        </div>
      </div>{' '}
    </section>
  );
